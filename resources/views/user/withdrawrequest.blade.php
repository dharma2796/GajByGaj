...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Request for Withdraw</title>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php $maxamount=floor($user->remainingIncome()); ?>
                                        @else
                                        <?php $maxamount=floor($user->bonusReward()->sum('remaining')); ?>
                                        @endif
                                        <h4 class="card-title mb-4">Request for withdraw (Available : $ {{$maxamount}})</h4>
                                       ...
                                       <?php $n=1; $m=0; $msg='';?>
                                        ...
                                        @if(date('d')==15 || date('d')==date('t') || ceil($user->bonusReward()->sum('remaining'))>=10)
                                        ...
                                        <input type="hidden" name="honeypotu" value="{{\Session::get('logtime')}}">
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="number" id="amountusdt" name="amountusdt" class="form-control" placeholder="amount" aria-describedby="basic-addon2" required="" value="" min="20" max="{{$maxamount}}" step="0.01">
                                                    @error('amountusdt')
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-sm-9">
                                                    ...
                                                    @else
                                                        @if(ceil($user->remainingIncome())>=20 || ceil($user->bonusReward()->sum('remaining'))>=20)
                                                            <button type="submit" class="btn btn-primary w-md" onclick="this.disabled=true;this.value='Processing, please wait...';this.form.submit();">Submit</button>
                                                        @else
                                                            <p> You do not have enough balance.Please first have some. min is 20 USDT</p>
                                                        @endif
                                                    @endif
