                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <select id="levelstatus" name="levelstatus" class="form-control @error('levelstatus') is-invalid @enderror">
                                            <option value="{{$editdata->level_status}}">{{$editdata->level_status}}</option>
                                            <option value="Not Open">Not Open</option>
                                            <option value="Open">Open</option>
                                            <option value="Admin Open">Admin Open</option>
                                          </select>
                                          @error('levelstatus')
                                             <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
