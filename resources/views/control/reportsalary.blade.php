...
<head>
    ...
    <link rel="stylesheet" href="{{asset('ctassets/datatable/jquery.dataTables.min.css')}}">
    <link rel="stylesheet" href="{{asset('ctassets/datatable/buttons.dataTables.min.css')}}">
...
@include('control.sidebaradmin')
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Salary Bonus Report</h1>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/SalaryReport" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Salary Bonus Report</h2>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    @foreach($reportsalary as $reportsalary)
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$reportsalary->email}}</td>
                                                        <td>{{$reportsalary->name}}</td>
                                                        <td>{{round($reportsalary->amount,2)}}</td>
                                                        <td>{{$reportsalary->created_at}}</td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
    ...
    <script src="{{asset('ctassets/datatable/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('ctassets/datatable/dataTables.buttons.min.js')}}"></script>
    <script src="{{asset('ctassets/datatable/jszip.min.js')}}"></script>
    <script src="{{asset('ctassets/datatable/buttons.html5.min.js')}}"></script>
    <script>
