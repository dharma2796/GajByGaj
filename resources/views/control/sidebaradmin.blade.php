        <div class="page-sidebar fixedscroll">
            ...
            <div class="page-sidebar-wrapper" id="main-menu-wrapper">
                ...
                <ul class='wraplist'>
                    ...
                    <li class="">
                        <a href="javascript:;">
                            <i class="img"><img src="{{asset('ctassets/images/icon/wallet-o.png')}}" style="width:16px" alt=""></i>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a class="" href="/Main/AdminBogTopup">Admin System Topup</a>
                            </li>
                            <li>
                                <a class="" href="/Main/AdminBogTopupReport">Admin System Topup History</a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                        ...
                        <ul class="sub-menu">
                            ...
                            <!-- <li>
                                <a class="" href="/Main/CappingUsers">Capped Members</a>
                            </li> -->
                        </ul>
                    </li>
                    <li class="">
                    ...
                    <li class="">
                        ...
                        <ul class="sub-menu">
                            ...
                            <!-- <li>
                                <a class="" href="/Main/LockedHistory">Locked Staking History</a>
                            </li> -->
                        </ul>
                    </li>
                    <li class="">
                        <a href="javascript:;">
                            <i class="img"><img src="{{asset('ctassets/images/icon/coins.png')}}" style="width:16px" alt=""></i>
                            <span class="title">Income Report</span>
                            <span class="arrow "></span>
                        </a>
                        <ul class="sub-menu">
                            <li>
                                <a class="" href="/Main/PeriodStakingReport">Trading Dividend Report</a>
                            </li>
                            <li>
                                <a class="" href="/Main/DirectBonusReport">Direct Bonus Report</a>
                            </li>
                            <li>
                                <a class="" href="/Main/LevelIncomeReport">Level Income Report</a>
                            </li>
                            <li>
                                <a class="" href="/Main/ClubIncomeReport">Generation Income Report</a>
                            </li>
                            <li>
                                <a class="" href="/Main/NobilityBonusReport">Generation Bonus Report</a>
                            </li>
                            <li>
                                <a class="" href="/Main/SalaryReport">Salary Report</a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                    ...
                    <li class="">
                        <a href="buy-and-sell.html">
                            <i class="img">
                                <img src="{{asset('ctassets/images/icon/coins.png')}}" style="width:16px" alt="">
                            </i>
